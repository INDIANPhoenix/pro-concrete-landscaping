...
export default function GardenDesignPage() {
  ...
  const process = [
    { step: 1, title: "Initial Consultation", description: "Discuss your vision and site requirements" },
    { step: 2, title: "Site Analysis", description: "Assess soil, drainage, and environmental factors" },
    { step: 3, title: "Design Development", description: "Create detailed plans and 3D visualizations" },
    { step: 4, title: "Plant Selection", description: "Choose appropriate plants for your climate" },
    { step: 5, title: "Final Plans", description: "Deliver complete design package" },
  ]
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-20 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">Professional Garden Design</h1>
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Transform your outdoor space with expert garden design. Custom plans, 3D visualizations, and plant
              selections tailored to your lifestyle.
            </p>
      ...
      <section className="py-16 bg-gradient-to-r from-emerald-600 to-teal-700 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Design Your Dream Garden?</h2>
          <p className="text-xl mb-8 opacity-90">Get professional garden design services today</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
